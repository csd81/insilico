...
export const HELP_PDE: Record<string, HelpEntry | string> = {
    ...
    pdearcl: { summary: 'Returns parameter values for a parametrized curve corresponding to a given set of arc length values.', syntax: ['pp = pdearcl(p,xy,s,s0,s1)'], seealso: ['pdegplot'], description: ['pp = pdearcl(p,xy,s,s0,s1) returns parameter values for a parametrized curve corresponding to a given set of arc length values.', 'The arc length values s,s0, and s1 can be an affine transformation of the arc length.'] },
