...
(`matlab/test/oracle/`, 269 committed fixtures) plus TS-only tests — 404 total,
...
| Symbolic math (`sym`) | Useful subset: `diff`, `int`, `solve`, `simplify`, `taylor`, `subs`, transforms. Not full Symbolic Toolbox. |
